...
export default function QualificationsSection() {
    ...
    return (
        <section ref={container} className="py-24 bg-[#020617] relative border-t border-slate-900 mb-0"> {/* Ensure no margin bottom to avoid gap */}
                    ...
                    <div className="md:w-1/3">
                        <div className="sticky top-32">
                            <div className="flex items-center gap-3 mb-6">
                                ...
                                <span className="text-secondary font-mono text-sm uppercase tracking-widest">Proven Expertise</span>
                            </div>

                            <h2 className="text-5xl md:text-6xl font-bold text-white mb-8 leading-tight">
                                Authorized <br />  <span className="text-slate-600">Partner.</span>
                            </h2>
                            <p className="text-slate-400 text-lg leading-relaxed mb-12">
                                Our strategies are backed by official certifications from the world's leading advertising platforms. We play by the rules to win big.
                            </p>
