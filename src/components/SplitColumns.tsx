...
export default function SplitColumns() {
    ...
    const content = {
        ar: {
            ...
            headline: (
                <>
                    مراحل  <br />العمل  <br /><span className="text-outline-white text-transparent"></span>
                </>
            ),
            features: [
                {
                    title: "البحث و التحليل",
                    desc: "قبل اطلاق الحملات يتم عمل بحث السوق والمنافسين لفهم المنتج \\الخدمة المقدمة ومعرفة الفئات المستهدفة",
                    image: "/strategy_blueprint_v3_1771881257824.png"
                },
                {
                    title: "ربط ادوات التتبع  ",
                    desc: "يتم التاكد من ربط جميع ادوات التتبع مثل GTM - GA4 - clarty - pixels .",
                    image: "/hero_data_strategy_ai_1771881188950.png"
                },
                {
                    title: "تحديد الميزانية و اطلاق الحملات الاختبارية ",
                    desc: "بعد المرور علي المرحلتين الاولي والثانية نكون قادرين علي تحديد الميزانية المناسبة - مستعدين علي اطلاق الحملات الاختبارية علي المنصات",
