export const caseStudiesData = {
    ar: [
        {
            ...
            results: [
                { label: "زيادة العائد", value: "+250%" },
                { label: "معدل النقر", value: "+180%" },
                { label: "التحويلات", value: "+320%" },
                { label: "تكلفة النقرة", value: "-45%" }
            ],
        ...
        },
        {
            ...
            results: [
                { label: "توسع الوصول", value: "+190%" },
                { label: "معدل التفاعل", value: "+165%" },
                { label: "زيارات الموقع", value: "+280%" },
                { label: "نمو المبيعات", value: "+210%" }
            ],
        ...
        },
        {
            ...
            results: [
                { label: "الوصول", value: "2.25M" },
                { label: "مرات الظهور", value: "5M+" },
                { label: "حملة ناجحة", value: "12" },
                { label: "الإنفاق", value: "20K ريال" }
            ],
        ...
        },
        {
            ...
            results: [
                { label: "ريال إنفاق", value: "4M+" },
                { label: "النقرات", value: "3.3M" },
                { label: "التحويلات", value: "150K" },
                { label: "سنوات النمو", value: "1.5" }
            ],
            tags: ["عقارات", "إدارة ميزانيات", "أداء"]
        },
        {
            slug: "cosmetics-revenue-scaling",
            ...
            results: [
                { label: "إجمالي المبيعات", value: "9.9M" },
                { label: "العائد (ROAS)", value: "14x" },
                { label: "عمليات الشراء", value: "6,000" },
                { label: "الإنفاق", value: "700K" }
            ],
            tags: ["مستحضرات تجميل", "نمو مبيعات", "تجارة إلكترونية"]
        },
        {
            slug: "ecommerce-tissue-growth",
            ...
            results: [
                { label: "عملية شراء", value: "6K" },
                { label: "معدل التحويل", value: "3.19%" },
                { label: "جلسات الموقع", value: "200K+" },
    ...
    en: [
        ...
        },
        {
            ...
            results: [
                { label: "Reach Expansion", value: "+190%" },
        ...
        },
        {
            ...
            results: [
                { label: "Reach", value: "2.25M" },
                { label: "Impressions", value: "5M+" },
                { label: "Successful Campaigns", value: "12" },
                { label: "Spend", value: "20K SAR" }
            ],
        ...
        },
        {
            ...
            results: [
                { label: "Spend (SAR)", value: "4M+" },
                { label: "Clicks", value: "3.3M" },
                { label: "Conversions", value: "150K" },
                { label: "Years Growth", value: "1.5" }
            ],
            tags: ["Real Estate", "Budget Management", "Performance"]
        },
        {
            slug: "cosmetics-revenue-scaling",
            client: "Cosmetics",
            ...
            results: [
                { label: "Total Revenue", value: "9.9M" },
                { label: "ROAS", value: "14x" },
                { label: "Purchases", value: "6,000" },
                { label: "Spend", value: "700K" }
            ],
            tags: ["Cosmetics", "Sales Growth", "E-commerce"]
        },
        {
            slug: "ecommerce-tissue-growth",
            client: "E-commerce (Tissues)",
            ...
            results: [
                { label: "Purchases", value: "6K" },
                { label: "Conv. Rate", value: "3.19%" },
                { label: "Sessions", value: "200K+" },
